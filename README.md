...
- **Cost PMPM Trends by SVC & Race Group:** Medicare's average spending on care for each beneficiary every month.
...
Across the 3 KPIs, Medicare’s performance for beneficiaries appears to decline significantly by 2010. Under the Total svc group, the 3 KPIs rose modestly from 2008→2009 (MLR +2.1%, Cost PMPM +9.5%, Count PMPM +6.3%), then fell sharply from 2009→2010 (−45.5%, −37.8%, −35.8%), landing at MLR 164.2%, $223.8 PMPM, and 2.2 claims PMPM. In practical terms, beneficiaries received fewer covered services and Medicare paid less per member, even as the claims rate decreased. The report further decomposes these KPIs by svc, race groups, and component measures to identify what influences are driving this dip in performance. These influences include positive factors (prevention, unit-price reductions, fewer complications, shift to home care), negative factors (higher patient cost sharing, tighter prior authorization, narrower networks, delayed claims), or a combination of both.
